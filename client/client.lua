...
-- ============================================================
-- HELPER: PROGRESS BAR
-- Must always be called from within a CreateThread coroutine.
-- ============================================================
...
-- ============================================================
-- BOX OPENING
-- Wrapped in CreateThread so lib.progressBar and Wait() calls
-- are always executed inside a proper FiveM coroutine thread,
-- guaranteeing compatibility across all ox_lib versions.
-- ============================================================
...
-- ============================================================
-- SMOKE CIGARETTE
-- Wrapped in CreateThread for the same reason as OpenBox.
-- ============================================================
    ...
    for locationIndex, location in ipairs(Config.SmokingShop.locations) do
        for coordIndex, coords in ipairs(location.coords) do
            ...
            elseif Config.Interaction == "ox" then
                ...
                -- drawtext: native FiveM help text proximity loop
...
-- Triggered by server after usable item fires for a box
RegisterNetEvent('di_smoking:client:openBox')
AddEventHandler('di_smoking:client:openBox', function(itemName)
    OpenBox(itemName)
end)

-- Triggered by server after usable item fires for a cigarette
...
-- esx:playerLoaded passes the ESX client player object (xPlayer).
-- esx:onPlayerDataChange fires on any field update (inventory, money, etc).
-- ============================================================
